 ...
 */
class getSeriesCategoriesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SeriesCategoriesRepository' shared autowired service.
     *
     * @return \App\Repository\SeriesCategoriesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SeriesCategoriesRepository.php';

        return $container->privates['App\\Repository\\SeriesCategoriesRepository'] = new \App\Repository\SeriesCategoriesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
