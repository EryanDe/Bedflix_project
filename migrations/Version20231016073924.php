 ...
 */
final class Version20231016073924 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE series_categories_categories ADD CONSTRAINT FK_80E93E1F6C977BFB FOREIGN KEY (series_categories_id) REFERENCES series_categories (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE series_categories_categories ADD CONSTRAINT FK_80E93E1FA21214B7 FOREIGN KEY (categories_id) REFERENCES categories (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE films_categories_categories ADD CONSTRAINT FK_6A2179E62EBEE5F7 FOREIGN KEY (films_categories_id) REFERENCES films_categories (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE films_categories_categories ADD CONSTRAINT FK_6A2179E6A21214B7 FOREIGN KEY (categories_id) REFERENCES categories (id) ON UPDATE NO ACTION ON DELETE CASCADE');
    }
}
